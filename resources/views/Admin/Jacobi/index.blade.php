...
<body>
   @include('Includes.navbar')
    <div class="flex justify-center">
        <div class="w-3/4">
            <h1 class="text-3xl font-bold text-center"> Jacobiho metóda</h1>
            <div class="flex justify-between">
                ...
                <button class="bg-white border-2 border-solid border-[#ff7900] text-[#ff7900] p-2 rounded-lg  font-semibold hover:bg-[#ff7900] hover:text-white hover:shadow-lg" ><a href="{{route('admin.jacobi.create')}}">vytvor</a></button>    
            </div>
            ...
            @forelse ($collection as $item)
                <div class="p-2 m-2 border-solid border-2 border-black flex justify-between items-center"  >
                    ...
                    <button><a href="{{route('admin.jacobi.edit', ['id' => $item->id])}}">úprava</a></button>
