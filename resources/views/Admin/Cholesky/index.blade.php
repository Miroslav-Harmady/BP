     ...
     <div class="flex justify-center">
        <div class="w-3/4">
            ...
            <div class="flex justify-between my-4">
                ...
                <button class="bg-white border-2 border-solid border-[#ff7900] text-[#ff7900] p-2 rounded-lg  font-semibold hover:bg-[#ff7900] hover:text-white hover:shadow-lg" ><a href="{{route('admin.cholesky.create')}}">vytvor</a></button>    
            </div>
            ...
            @forelse ($collection as $item)
                <div class="p-2 m-2 border-solid border-2 border-black flex justify-between items-center" >
                    ...
                    <button><a href="{{route('admin.cholesky.edit', ['id' => $item->id])}}">úprava</a></button>
