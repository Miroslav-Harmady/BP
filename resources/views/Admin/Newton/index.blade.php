...
<body>
    ...
    @forelse ($collection as $item)
        <div class="p-2 m-2 border-solid border-2 border-black flex justify-between items-center" >
            ...
            <a href="{{route('admin.newton.edit', ['id' => $item->id])}}" class="p-1 font-semibold text-blue-500 border-2 border-blue-500 rounded-lg hover:text-white hover:bg-blue-500  "><button>Úprava</button></a>
