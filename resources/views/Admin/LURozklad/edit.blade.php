            ...
            <div class="grid grid-cols-1 justify-items-center">
                <div class="grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-items-begin mb-4">
                    <div>
                        ...
                        <div>
                            <input type="text" name="inputLeft" id="inputLeft" placeholder="sem vlozte maticu z latexu" value="{{$item->left}}">
                        </div>
                        @error('inputLeft')
                    ...
                    <div>
                        ...
                        <div>
                            <input type="text" name="inputRight" id="inputRight" placeholder="sem vlozte maticu z latexu" value="{{$item->right}}">
                        </div>
                        @error('inputRight')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div>
                        ...
                        <div>
                            <input type="text" name="resultU" id="resultU" value="{{$item->resultU}}">
                        </div>
                        @error('resultU')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
